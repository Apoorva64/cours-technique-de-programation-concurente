public class Exercice3Q3 {
    ...
    static class ThreadInfo {
        ...
        long padding1, padding2, padding3, padding4;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < threads.length; i++) {
            ...
            // Utiliser artificiellement les variables de padding
            infos[threadId].padding1++;
            infos[threadId].padding2++;
            infos[threadId].padding3++;
            infos[threadId].padding4++;
